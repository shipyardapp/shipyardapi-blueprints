...
def form_url(organization_id, project_id, fleet_id):
    """
    Returns the url that will be used to form the request
    """

    return f"https://api.app.shipyardapp.com/orgs/{organization_id}/projects/{project_id}/fleets/{fleet_id}/runs"
...
def form_request(url,api_key):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("Please ensure that org id, api token, and fleet id is correct")
...
def main():
    ...
    url = form_url(org_id, project_id, fleet_id)
